...
import ReplaceAssessmentModal from '@/thesis/pages/ThesisPage/components/ThesisAssessmentSection/components/ReplaceAssessmentModal/ReplaceAssessmentModal'
