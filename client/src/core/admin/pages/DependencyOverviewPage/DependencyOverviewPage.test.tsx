...
vi.mock('@/core/admin/requests/dependencyOverview', () => apiMock)
vi.mock('@/core/utils/notification', () => notifyMock)

import { renderWithProviders, screen, userEvent, waitFor } from '@/../test/render'
import DependencyOverviewPage from '@/core/admin/pages/DependencyOverviewPage/DependencyOverviewPage'
