...
import type { IUpdateUserInformationPayload } from '@/core/user/requests/payloads/user'
import {
  Anchor,
  Button,
  Checkbox,
...
import UploadArea from '@/core/components/UploadArea/UploadArea'
import { useEffect, useState } from 'react'
import DocumentEditor from '@/core/components/DocumentEditor/DocumentEditor'
import { useApiPdfFile } from '@/core/hooks/fetcher'
import { showSimpleError } from '@/core/utils/notification'
import { getHtmlTextLength } from '@/core/utils/validation'
