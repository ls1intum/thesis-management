...
import { useApplicationsContextUpdater } from '@/core/application/providers/ApplicationsProvider/hooks'
...
import { formatDate, formatThesisType, getDefaultLanguage } from '@/core/utils/format'
