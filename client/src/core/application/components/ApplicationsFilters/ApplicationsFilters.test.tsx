...
import type { IApplicationsFilters } from '@/core/application/providers/ApplicationsProvider/context'

const setFilters = vi.fn()
const setSort = vi.fn()
let filters: IApplicationsFilters = { includeSuggestedTopics: true }

vi.mock('@/core/application/providers/ApplicationsProvider/hooks', () => ({
