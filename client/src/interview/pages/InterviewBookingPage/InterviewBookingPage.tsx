...
import SummaryCard from '@/interview/pages/InterviewBookingPage/components/SummaryCard'
import {
  BuildingOfficeIcon,
  CalendarDotsIcon,
  ClockIcon,
...
import SelectSlotCarousel from '@/interview/pages/InterviewBookingPage/components/SelectSlotCarousel'
