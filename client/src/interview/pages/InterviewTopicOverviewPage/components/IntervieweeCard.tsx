...
import type { IIntervieweeLightWithNextSlot } from '@/interview/requests/responses/interview'
...
import InterviewSlotInformation from '@/interview/components/InterviewSlotInformation/InterviewSlotInformation'
import { CheckCircleIcon, PaperPlaneTiltIcon, XCircleIcon, XIcon } from '@phosphor-icons/react'
import InviteConfirmationModal from '@/interview/pages/InterviewTopicOverviewPage/components/InviteConfirmationModal'
import { useState } from 'react'
import CancelSlotConfirmationModal from '@/interview/pages/InterviewTopicOverviewPage/components/CancelSlotConfirmationModal'
import AcceptApplicantModal from '@/interview/pages/InterviewTopicOverviewPage/components/AcceptApplicantModal'
