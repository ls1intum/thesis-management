...
const DataExportPage = () => {
  ...
  return (
    <div>
      <Title mb='md'>Data Export</Title>

      <Stack gap='md'>
        <Text>
          You can request an export of all your personal data stored in the system. This includes
          your profile information, applications, theses, and uploaded documents. The export is
          generated as a ZIP file containing structured JSON data and your uploaded files.
        </Text>

        <Text size='sm' c='dimmed'>
          Exports are processed overnight and you will receive an email when your export is ready.
          The download link is valid for 7 days. You can request a new export every 7 days.
        </Text>
