...
import TopicCard from '@/app/pages/LandingPage/components/TopicCardGrid/TopicCard/TopicCard'
import { TopicsContext } from '@/core/topic/providers/TopicsProvider/context'
import { Database } from '@phosphor-icons/react'
import type { Dispatch } from 'react'
import { use, useEffect, useState } from 'react'
import type { ITopic, ITopicOverview } from '@/core/topic/requests/responses/topic'
...
import CollapsibleTopicElement from '@/core/application/pages/ReplaceApplicationPage/components/SelectTopicStep/components/CollapsibleTopicElement'
