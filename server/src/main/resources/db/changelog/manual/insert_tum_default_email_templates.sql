...
</hr><div style="text-align: center;font-size: 10px"> Manage your notification settings <a href="${config.clientHost + ''/settings/notifications''}">here</a></div>', 'Public Presentation Invitation'), ('THESIS_PRESENTATION_INVITATION_CANCELLED', 'Thesis Presentation Cancelled', '<p>Dear [[${recipient.firstName}]],</p><p>The [[${thesis.type}]] thesis presentation of <strong>[[${thesis.students}]]</strong> scheduled at [[${presentation.scheduledAt}]] was cancelled.</p><p><hr/>
</hr><div style="text-align: center;font-size: 10px"> Manage your notification settings <a href="${config.clientHost + ''/settings/notifications''}">here</a></div>', 'Public Presentation was deleted'), ('THESIS_PRESENTATION_INVITATION_UPDATED', 'Thesis Presentation Updated', '<h2 style="text-align: center;">INVITATION</h2><p style="text-align: center;">As part of their [[${thesis.type}]]''s thesis<br><strong>[[${thesis.students}]]</strong><br>will give their [[${presentation.type}]] presentation on<br><strong>[[${presentation.scheduledAt}]]</strong><br>online at [[${presentation.streamUrl}]]<br>and&nbsp;onsite in <strong>[[${presentation.location}]]</strong><br><br>Title:<br>[[${thesis.title}]]</p><p style="text-align: center;"></p><p style="text-align: center;">Supervisor: [[${thesis.supervisors}]]<br>Advisor(s): [[${thesis.advisors}]]<br></p><p style="text-align: center;">The presentation will be in [[${presentation.language}]]. Everybody is cordially invited to attend.</p><p><strong>Abstract</strong><br><span th:utext="${thesis.abstractText}"></span></p><p>Full Details: [[${presentationUrl}]]</p><p><hr/>
</hr><div style="text-align: center;font-size: 10px"> Manage your notification settings <a href="${config.clientHost + ''/settings/notifications''}">here</a></div>', 'Public Presentation was updated'), ('THESIS_PROPOSAL_ACCEPTED', 'Thesis Proposal Accepted', '<p th:inline="text">Dear [[${recipient.firstName}]],</p>
