...
--changeset consistent-email-footer:40-add-email-signature-column
ALTER TABLE research_group_settings ADD COLUMN email_signature TEXT;

--changeset consistent-email-footer:40-replace-best-regards-with-signature-variable
...
--changeset consistent-email-footer:40-replace-config-signature-with-email-signature
...
--changeset consistent-email-footer:40-remove-notification-links-multiline
...
--changeset consistent-email-footer:40-remove-notification-links-inline
...
--changeset consistent-email-footer:40-remove-trailing-br
...
--changeset consistent-email-footer:40-add-signature-to-templates-without
