...
- `POST /v2/ai-review/preview` — same body. Runs the pipeline and returns an `AIPreviewResponseDTO` (overall assessment + summary + editable drafts) **without saving anything**. Supervisor-only.
