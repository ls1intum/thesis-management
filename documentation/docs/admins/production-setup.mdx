...
sidebar_position: 3
description: Example production docker-compose file, backup script, and deployment notes.
---


Example production [docker-compose.prod.yml](https://github.com/ls1intum/thesis-management/blob/develop/docker-compose.prod.yml) file. 
You can follow the steps in [deploy_docker.yml](https://github.com/ls1intum/thesis-management/blob/develop/.github/workflows/deploy_docker.yml) to see how it is used.
...
3. Setup a production keycloak instance. Guide for first time setup can be found in [Development Setup](/developer/development-setup)
...
There is an example script [thesis-management-backup.sh](https://github.com/ls1intum/thesis-management/blob/develop/supporting_scripts/thesis-management-backup.sh) that you can call in a cronjob to create regular backups.

## Further Configuration

All further environment variables can be found [here](/admin/configuration) 

If you want to modify the emails, you can read about that [here](/developer/mails) 
